  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <p className="subtitle">Explore Blind 75 questions by topic, subtopic, or ID.</p>
      ...
      <main className="content">
        ...
        {state.loading ? (
          ...
          <div className="content-body">
            ...
            />
            <QuestionDetails
              question={state.selectedQuestion ?? (searchId ? questionLookup.get(Number.parseInt(searchId, 10)) : null)}
            />
          </div>
        )}
      </main>
